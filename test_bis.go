...
//Fonction qui prend en paramètre un fichier .txt, l'ouvre et nous renvoie un tableau de String contenant les phrases du texte 
...
func stringInText(s1 string, s2 string, s2_name string){
	...
	string_in_text := strings.Contains(s2, s1)
...
func compareText(database_text_name string, received_text []string){
